...
public class WanaKanaJava {
    ...
    static final int LOWERCASE_ZENKAKU_START = 0xff41;
    static final int LOWERCASE_ZENKAKU_END = 0xff5a;
    static final int UPPERCASE_ZENKAKU_START = 0xff21;
    static final int UPPERCASE_ZENKAKU_END = 0xff3a;
    static final int HIRAGANA_START = 0x3041;
    static final int HIRAGANA_END = 0x3096;
    static final int KATAKANA_START = 0x30A1;
    static final int KATAKANA_END = 0x30FC;
    static final int KANJI_START = 0x4e00;
    static final int KANJI_END = 0x9faf;
    static final int PROLONGED_SOUND_MARK = 0x30fc;
    static final int KANA_SLASH_DOT = 0x30fb;

    static final int ZENKAKU_NUMBER_START = 0xff10;
    static final int ZENKAKU_NUMBER_END = 0xff19;
    static final int ZENKAKU_PUNCTUATION_1_START = 0xff01;
    static final int ZENKAKU_PUNCTUATION_1_END = 0xff0f;
    static final int ZENKAKU_PUNCTUATION_2_START = 0xff1a;
    static final int ZENKAKU_PUNCTUATION_2_END = 0xff1f;
    static final int ZENKAKU_PUNCTUATION_3_START = 0xff3b;
    static final int ZENKAKU_PUNCTUATION_3_END = 0xff3f;
    static final int ZENKAKU_PUNCTUATION_4_START = 0xff5b;
    static final int ZENKAKU_PUNCTUATION_4_END = 0xff60;
    static final int ZENKAKU_SYMBOLS_CURRENCY_START = 0xffe0;
    static final int ZENKAKU_SYMBOLS_CURRENCY_END = 0xffee;

    static final int HIRAGANA_CHARS_START = 0x3040;
    static final int HIRAGANA_CHARS_END = 0x309f;
    static final int KATAKANA_CHARS_START = 0x30a0;
    static final int KATAKANA_CHARS_END = 0x30ff;
    static final int HANKAKU_KATAKANA_START = 0xff66;
    static final int HANKAKU_KATAKANA_END = 0xff9f;
    static final int KATAKANA_PUNCTUATION_START = 0x30fb;
    static final int KATAKANA_PUNCTUATION_END = 0x30fc;
    static final int KANA_PUNCTUATION_START = 0xff61;
    static final int KANA_PUNCTUATION_END = 0xff65;
    static final int CJK_SYMBOLS_PUNCTUATION_START = 0x3000;
    static final int CJK_SYMBOLS_PUNCTUATION_END = 0x303f;
    static final int COMMON_CJK_START = 0x4e00;
    static final int COMMON_CJK_END = 0x9fff;
    ...
    public boolean isKanji(char character) {
        return KANJI_START <= character && character <= KANJI_END;
    }

    public boolean isKanji(String text) {
        return text.chars().allMatch(ch -> this.isKanji((char) ch));
    }

    public boolean isJapanese(char character) {
        return (HIRAGANA_CHARS_START <= character && character <= HIRAGANA_CHARS_END)
                || (KATAKANA_CHARS_START <= character && character <= KATAKANA_CHARS_END)
                ...
                || (ZENKAKU_PUNCTUATION_4_START <= character && character <= ZENKAKU_PUNCTUATION_4_END)
                || (ZENKAKU_SYMBOLS_CURRENCY_START <= character && character <= ZENKAKU_SYMBOLS_CURRENCY_END)
                || (UPPERCASE_ZENKAKU_START <= character && character <= UPPERCASE_ZENKAKU_END)
                || (LOWERCASE_ZENKAKU_START <= character && character <= LOWERCASE_ZENKAKU_END)
                || (ZENKAKU_NUMBER_START <= character && character <= ZENKAKU_NUMBER_END)
